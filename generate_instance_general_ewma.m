function [ G,server,client,request, c_cache, c_link, rand_c_link,demand_SP ] = generate_instance_general_ewma( n_week,window_size,A,cmin,cmax,cmin_s,cmax_s,C,skewness,deg_client,n_client, linkmin, linkmax, c_v, c_client, k_paths)
...
t = csvread('data/GP_top30_videos_85_15_train_test_11_15.csv',1,0);
