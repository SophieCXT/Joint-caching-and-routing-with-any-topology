function [ c_RNR, c_RNR_Ioannidis, c_RNR_SP ] = simulate_unlimited_link_capacities_gurobi( A,C,c_v,c_client,k_paths, G,server,client,request, candidatePaths, candidatePaths1)
V = length(A);
