function [  G,server,client,request ] = generate_instance_unlimited_link_capacities_online_settings( n_timestamp,batch_num, A,cmin,cmax,cmin_s,cmax_s,n_client,C )
