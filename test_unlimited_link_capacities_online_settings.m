...
[ G,server,client,request ] = online_settings_generate_instance_unlimited_link_capacities( n_week,window_size,A,cmin,cmax,cmin_s,cmax_s,n_client,C );
...
for i_cv = 1:length(C_client)
    ...
    [ c_RNR, c_RNR_Ioannidis, c_RNR_SP ] = simulate_unlimited_link_capacities_gurobi( A,C,c_v,c_client,k_paths,  G,server,client,request, candidatePaths, candidatePaths1);
...
save(['data/online_settings/no_link_capacity_cachecapacity_C_' num2str(C) '_edgecachesize_' num2str(c_client) '_' topology '.mat'], 'C_client','C_RNR'); 
...
save(['data/online_settings/no_link_capacity_candidatepaths_C_' num2str(C) '_edgecachesize_' num2str(c_client) '_' topology '.mat'], 'K_paths','C_RNR','c_client'); 
...
set(gca, 'FontSize', fontsize);
% title(['Topology ', topology, ', C=' num2str(C), ', skewness=' num2str(skewness)])
saveas(gcf,['data/online_settings/no_link_capacity_candidatepaths_C_' num2str(C) '_edgecachesize_' num2str(c_client) '_' topology],'epsc')
