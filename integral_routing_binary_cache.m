function [ cost, load, paths, request_type, cost_splittable, load_splittable ] = integral_routing_binary_cache( G, c_link, Vs, request, K )
...
[ cost, load_vector, paths, links, cost_splittable, load_vector_splittable ] = bicriteria_MSUFP( G, c_link, s, d, lambda, K );
